<?php
    ...
    if (isset($_POST['sbm'])) {
        ...
        // upload image
        //$prd_image = $_FILES['prd_image']['size']; // lấy dung lượng file upload
        //$prd_image = $_FILES['prd_image']['type']; // lấy đuôi của file
        //$prd_image = $_FILES['prd_image']['error']; // cảnh báo lỗi có 5 giá trị(0: là thành công) (1, 2, 3, 4: là lỗi)
        //$prd_image = $_FILES['prd_image']['tmp_name']; // chỉ đường dẫn file được upload lên thư mục tạm trên server
        $prd_image = $_FILES['prd_image']['name']; // lấy tên của file được upload
        ...
        $query = mysqli_query($conn, $sql);
        // move_uploaded_file(đường dẫn cũ là trong thư mục tmp, đường dẫn mới là trong project);
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="inputFile" style="cursor: pointer;" required name="prd_image" type="file">
                            <br>
                            <div>
                                <img id="image_product" style="height: 400px; width: 270px;" alt="Hiển thị ảnh Upload" src="">
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    image_product.style.display = "none";
    inputFile.onchange = function () {
        ...
        if (file.length !== 0) {
            ...
            obj.onload = function (data) {
                ...
                image_product.src = data.target.result;
            }
            obj.readAsDataURL(file[0]);
        }
    } 
</script>